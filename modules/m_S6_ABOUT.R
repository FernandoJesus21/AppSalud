  ...
  tabsetPanel(type = "tabs",
              tabPanel(
                ...
                div(class = "info-project-text",
                    ...
                    div(class = "logo-uno",
                        HTML(
                        "<a href='http://uno.edu.ar/', target='_blank'><img src='assets/UNO-logo-web.png' alt='logo' style='width:220px;height:75px;'></a>"),
                    ),
                    div(class = "shapes",
                        HTML(
              ...
              tabPanel(
                textOutput(ns("SS_tab_4")),
                       div(class = "info-resource-text",
                         HTML("<img src='assets/digital_card_v3s.png' alt='logo' style='width:651px;height:465px;'>")
                       )
              )
  )
  )
